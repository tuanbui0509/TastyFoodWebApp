    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "b7ab091e-0019-4b43-a1f9-e6badecfef43", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "7ee34c07-e5d6-44e1-b646-e134d5b2c0d5", new DateTime(2021, 7, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "tuanbui0509@gmail.com", true, "Tuan", "Ngoc", false, null, "tuanbui0509@gmail.com", "admin", "AQAAAAEAACcQAAAAEJKpI7vp2wxh/UgkEcDftjCt53DT79QiiSPEm6LPDsFHUP6/z8d7OrQ8AOsaj75IXw==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "Bánh mì", null, 1, 1 },
                    { 2, true, "Đồ ăn nhanh", null, 1, 1 }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "DateCreated", "Description", "IsFeatured", "Name", "OriginalPrice", "Price" },
                values: new object[] { 1, 1, new DateTime(2021, 7, 16, 23, 19, 13, 229, DateTimeKind.Local).AddTicks(2419), "Bánh mì ăn sáng Việt Nam", null, "Bánh mì ăn sáng", 100000m, 200000m });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "DateCreated", "Description", "IsFeatured", "Name", "OriginalPrice", "Price" },
                values: new object[] { 2, 2, new DateTime(2021, 7, 16, 23, 19, 13, 230, DateTimeKind.Local).AddTicks(980), "Gà rán Việt Nam", null, "Gà rán", 150000m, 500000m });
